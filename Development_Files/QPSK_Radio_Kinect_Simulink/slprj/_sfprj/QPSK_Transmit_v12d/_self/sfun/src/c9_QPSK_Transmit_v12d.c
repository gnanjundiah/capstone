...
static void initialize_params_c9_QPSK_Transmit_v12d
  (SFc9_QPSK_Transmit_v12dInstanceStruct *chartInstance);
static void enable_c9_QPSK_Transmit_v12d(SFc9_QPSK_Transmit_v12dInstanceStruct
  *chartInstance);
static void disable_c9_QPSK_Transmit_v12d(SFc9_QPSK_Transmit_v12dInstanceStruct *
  chartInstance);
static void c9_update_debugger_state_c9_QPSK_Transmit_v12d
  (SFc9_QPSK_Transmit_v12dInstanceStruct *chartInstance);
...
static void finalize_c9_QPSK_Transmit_v12d(SFc9_QPSK_Transmit_v12dInstanceStruct
  *chartInstance);
static void sf_c9_QPSK_Transmit_v12d(SFc9_QPSK_Transmit_v12dInstanceStruct
  *chartInstance);
static void initSimStructsc9_QPSK_Transmit_v12d
  (SFc9_QPSK_Transmit_v12dInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static cint16_T c9_emlrt_marshallIn(SFc9_QPSK_Transmit_v12dInstanceStruct
...
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static real_T c9_b_emlrt_marshallIn(SFc9_QPSK_Transmit_v12dInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static const mxArray *c9_e_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_c_emlrt_marshallIn(SFc9_QPSK_Transmit_v12dInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static void c9_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static uint8_T c9_f_emlrt_marshallIn(SFc9_QPSK_Transmit_v12dInstanceStruct
  *chartInstance, const mxArray *c9_b_is_active_c9_QPSK_Transmit_v12d, const
  char_T *c9_identifier);
static uint8_T c9_g_emlrt_marshallIn(SFc9_QPSK_Transmit_v12dInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_QPSK_Transmit_v12dInstanceStruct
  *chartInstance);
  ...
  (SFc9_QPSK_Transmit_v12dInstanceStruct *chartInstance)
{
  ...
  c9_hoistedGlobal = chartInstance->c9_is_active_c9_QPSK_Transmit_v12d;
...
const mxArray *sf_c9_QPSK_Transmit_v12d_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c9_identifier)
{
  ...
  c9_y = c9_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_QPSK_Transmit_v12d), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_QPSK_Transmit_v12d);
  return c9_y;
}
...
/* SFunction Glue Code */
void sf_c9_QPSK_Transmit_v12d_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c9_QPSK_Transmit_v12d_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c9_QPSK_Transmit_v12d(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"d_out\",},{M[8],M[0],T\"is_active_c9_QPSK_Transmit_v12d\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_QPSK_Transmit_v12d_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc9_QPSK_Transmit_v12dInstanceStruct *chartInstance;
    chartInstance = (SFc9_QPSK_Transmit_v12dInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c9_QPSK_Transmit_v12d(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_QPSK_Transmit_v12dInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_QPSK_Transmit_v12d((SFc9_QPSK_Transmit_v12dInstanceStruct*)
    chartInstanceVar);
  initialize_c9_QPSK_Transmit_v12d((SFc9_QPSK_Transmit_v12dInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_QPSK_Transmit_v12d(void *chartInstanceVar)
{
  enable_c9_QPSK_Transmit_v12d((SFc9_QPSK_Transmit_v12dInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c9_QPSK_Transmit_v12d(void *chartInstanceVar)
{
  disable_c9_QPSK_Transmit_v12d((SFc9_QPSK_Transmit_v12dInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_QPSK_Transmit_v12d(void *chartInstanceVar)
{
  sf_c9_QPSK_Transmit_v12d((SFc9_QPSK_Transmit_v12dInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_QPSK_Transmit_v12d(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_QPSK_Transmit_v12d
    ((SFc9_QPSK_Transmit_v12dInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_QPSK_Transmit_v12d();/* state var info */
...
extern void sf_internal_set_sim_state_c9_QPSK_Transmit_v12d(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c9_QPSK_Transmit_v12d((SFc9_QPSK_Transmit_v12dInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_QPSK_Transmit_v12d(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_QPSK_Transmit_v12d(S);
}

static void sf_opaque_set_sim_state_c9_QPSK_Transmit_v12d(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c9_QPSK_Transmit_v12d(S, st);
}
...
{
  initSimStructsc9_QPSK_Transmit_v12d((SFc9_QPSK_Transmit_v12dInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_QPSK_Transmit_v12d(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c9_QPSK_Transmit_v12d
      ((SFc9_QPSK_Transmit_v12dInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c9_QPSK_Transmit_v12d(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c9_QPSK_Transmit_v12d(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_QPSK_Transmit_v12d(SimStruct *S)
{
  SFc9_QPSK_Transmit_v12dInstanceStruct *chartInstance;
  chartInstance = (SFc9_QPSK_Transmit_v12dInstanceStruct *)malloc(sizeof
    (SFc9_QPSK_Transmit_v12dInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_QPSK_Transmit_v12dInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_QPSK_Transmit_v12d;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_QPSK_Transmit_v12d;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_QPSK_Transmit_v12d;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_QPSK_Transmit_v12d;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c9_QPSK_Transmit_v12d;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_QPSK_Transmit_v12d;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_QPSK_Transmit_v12d;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_QPSK_Transmit_v12d;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_QPSK_Transmit_v12d;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_QPSK_Transmit_v12d;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c9_QPSK_Transmit_v12d;
...
void c9_QPSK_Transmit_v12d_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_QPSK_Transmit_v12d(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_QPSK_Transmit_v12d(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_QPSK_Transmit_v12d(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_QPSK_Transmit_v12d_method_dispatcher.\n"
