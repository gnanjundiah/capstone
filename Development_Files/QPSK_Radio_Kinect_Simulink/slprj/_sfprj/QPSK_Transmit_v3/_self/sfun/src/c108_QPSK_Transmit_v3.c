...
#include "QPSK_Transmit_v3_sfun.h"
#include "c108_QPSK_Transmit_v3.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "QPSK_Transmit_v3_sfun_debug_macros.h"
...
static void initialize_c108_QPSK_Transmit_v3
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance);
static void initialize_params_c108_QPSK_Transmit_v3
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance);
static void enable_c108_QPSK_Transmit_v3(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance);
static void disable_c108_QPSK_Transmit_v3(SFc108_QPSK_Transmit_v3InstanceStruct *
  chartInstance);
static void c108_update_debugger_state_c108_QPSK_Transmit_v3
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c108_QPSK_Transmit_v3
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance);
static void set_sim_state_c108_QPSK_Transmit_v3
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance, const mxArray *c108_st);
static void finalize_c108_QPSK_Transmit_v3(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance);
static void sf_c108_QPSK_Transmit_v3(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance);
static void c108_chartstep_c108_QPSK_Transmit_v3
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance);
static void initSimStructsc108_QPSK_Transmit_v3
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance);
...
static const mxArray *c108_sf_marshallOut(void *chartInstanceVoid, void
  *c108_inData);
static void c108_emlrt_marshallIn(SFc108_QPSK_Transmit_v3InstanceStruct
...
static const mxArray *c108_c_sf_marshallOut(void *chartInstanceVoid, void
  *c108_inData);
static real_T c108_b_emlrt_marshallIn(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance, const mxArray *c108_u, const emlrtMsgIdentifier *c108_parentId);
...
static void c108_eml_error(SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance,
  int32_T c108_varargin_2);
static const mxArray *c108_d_sf_marshallOut(void *chartInstanceVoid, void
  *c108_inData);
static int32_T c108_c_emlrt_marshallIn(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance, const mxArray *c108_u, const emlrtMsgIdentifier *c108_parentId);
...
static const mxArray *c108_f_sf_marshallOut(void *chartInstanceVoid, void
  *c108_inData);
static void c108_d_emlrt_marshallIn(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance, const mxArray *c108_y, const char_T *c108_identifier, uint8_T
  c108_b_y[8]);
static void c108_e_emlrt_marshallIn(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance, const mxArray *c108_u, const emlrtMsgIdentifier *c108_parentId,
  uint8_T c108_y[8]);
static void c108_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c108_mxArrayInData, const char_T *c108_varName, void *c108_outData);
static uint8_T c108_f_emlrt_marshallIn(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance, const mxArray *c108_b_is_active_c108_QPSK_Transmit_v3, const
  char_T *c108_identifier);
static uint8_T c108_g_emlrt_marshallIn(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance, const mxArray *c108_u, const emlrtMsgIdentifier *c108_parentId);
static uint32_T c108__u32_minus__(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance, uint32_T c108_b, uint32_T c108_c);
static uint8_T c108__u8_u32_(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance, uint32_T c108_b);
static uint8_T c108__u8_d_(SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance,
  real_T c108_b);
static void init_dsm_address_info(SFc108_QPSK_Transmit_v3InstanceStruct
  *chartInstance);
  ...
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance)
{
  ...
  chartInstance->c108_is_active_c108_QPSK_Transmit_v3 = 0U;
  ...
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance)
{
  ...
  c108_hoistedGlobal = chartInstance->c108_is_active_c108_QPSK_Transmit_v3;
  ...
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance, const mxArray *c108_st)
{
  ...
  chartInstance->c108_is_active_c108_QPSK_Transmit_v3 = c108_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c108_u, 1)),
     "is_active_c108_QPSK_Transmit_v3");
  sf_mex_destroy(&c108_u);
  c108_update_debugger_state_c108_QPSK_Transmit_v3(chartInstance);
  ...
  *chartInstance)
{
  ...
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c108_sfEvent);
  ...
  chartInstance->c108_sfEvent = CALL_EVENT;
  c108_chartstep_c108_QPSK_Transmit_v3(chartInstance);
  sf_debug_check_for_state_inconsistency(_QPSK_Transmit_v3MachineNumber_,
  ...
  (SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance)
{
  ...
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c108_sfEvent);
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c108_sfEvent);
}
  ...
  *c108_inData)
{
  ...
  const mxArray *c108_b_y = NULL;
  SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance;
  chartInstance = (SFc108_QPSK_Transmit_v3InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c108_QPSK_Transmit_v3_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c108_identifier)
{
  ...
  c108_y = c108_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c108_b_is_active_c108_QPSK_Transmit_v3), &c108_thisId);
  sf_mex_destroy(&c108_b_is_active_c108_QPSK_Transmit_v3);
  return c108_y;
}
...
/* SFunction Glue Code */
void sf_c108_QPSK_Transmit_v3_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c108_QPSK_Transmit_v3_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c108_QPSK_Transmit_v3(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c108_QPSK_Transmit_v3\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c108_QPSK_Transmit_v3_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance;
    chartInstance = (SFc108_QPSK_Transmit_v3InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_QPSK_Transmit_v3MachineNumber_,
           108,
           1,
           1,
           2,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_QPSK_Transmit_v3MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_QPSK_Transmit_v3MachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_QPSK_Transmit_v3MachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration(_QPSK_Transmit_v3MachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c108_QPSK_Transmit_v3(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc108_QPSK_Transmit_v3InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c108_QPSK_Transmit_v3((SFc108_QPSK_Transmit_v3InstanceStruct*)
    chartInstanceVar);
  initialize_c108_QPSK_Transmit_v3((SFc108_QPSK_Transmit_v3InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c108_QPSK_Transmit_v3(void *chartInstanceVar)
{
  enable_c108_QPSK_Transmit_v3((SFc108_QPSK_Transmit_v3InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c108_QPSK_Transmit_v3(void *chartInstanceVar)
{
  disable_c108_QPSK_Transmit_v3((SFc108_QPSK_Transmit_v3InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c108_QPSK_Transmit_v3(void *chartInstanceVar)
{
  sf_c108_QPSK_Transmit_v3((SFc108_QPSK_Transmit_v3InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c108_QPSK_Transmit_v3(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c108_QPSK_Transmit_v3
    ((SFc108_QPSK_Transmit_v3InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c108_QPSK_Transmit_v3();/* state var info */
...
extern void sf_internal_set_sim_state_c108_QPSK_Transmit_v3(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c108_QPSK_Transmit_v3((SFc108_QPSK_Transmit_v3InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c108_QPSK_Transmit_v3(SimStruct* S)
{
  return sf_internal_get_sim_state_c108_QPSK_Transmit_v3(S);
}

static void sf_opaque_set_sim_state_c108_QPSK_Transmit_v3(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c108_QPSK_Transmit_v3(S, st);
}

static void sf_opaque_terminate_c108_QPSK_Transmit_v3(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc108_QPSK_Transmit_v3InstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c108_QPSK_Transmit_v3((SFc108_QPSK_Transmit_v3InstanceStruct*)
      chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_QPSK_Transmit_v3_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc108_QPSK_Transmit_v3((SFc108_QPSK_Transmit_v3InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c108_QPSK_Transmit_v3(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c108_QPSK_Transmit_v3
      ((SFc108_QPSK_Transmit_v3InstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c108_QPSK_Transmit_v3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_QPSK_Transmit_v3_optimization_info();
...
static void mdlRTW_c108_QPSK_Transmit_v3(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c108_QPSK_Transmit_v3(SimStruct *S)
{
  SFc108_QPSK_Transmit_v3InstanceStruct *chartInstance;
  chartInstance = (SFc108_QPSK_Transmit_v3InstanceStruct *)malloc(sizeof
    (SFc108_QPSK_Transmit_v3InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc108_QPSK_Transmit_v3InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c108_QPSK_Transmit_v3;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c108_QPSK_Transmit_v3;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c108_QPSK_Transmit_v3;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c108_QPSK_Transmit_v3;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c108_QPSK_Transmit_v3;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c108_QPSK_Transmit_v3;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c108_QPSK_Transmit_v3;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c108_QPSK_Transmit_v3;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c108_QPSK_Transmit_v3;
  chartInstance->chartInfo.mdlStart = mdlStart_c108_QPSK_Transmit_v3;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c108_QPSK_Transmit_v3;
...
void c108_QPSK_Transmit_v3_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c108_QPSK_Transmit_v3(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c108_QPSK_Transmit_v3(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c108_QPSK_Transmit_v3(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c108_QPSK_Transmit_v3_method_dispatcher.\n"
