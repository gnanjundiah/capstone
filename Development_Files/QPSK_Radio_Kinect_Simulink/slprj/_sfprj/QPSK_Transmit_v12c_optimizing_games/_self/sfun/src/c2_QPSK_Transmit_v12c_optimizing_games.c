...
#include "c2_QPSK_Transmit_v12c_optimizing_games.h"
...
static void initialize_c2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance);
static void initialize_params_c2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance);
static void enable_c2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance);
static void disable_c2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance);
static void set_sim_state_c2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance, const
   mxArray *c2_st);
static void finalize_c2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance);
static void sf_c2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance);
static void c2_chartstep_c2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance);
static void initSimStructsc2_QPSK_Transmit_v12c_optimizing_games
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance);
...
static void c2_emlrt_marshallIn
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId, uint8_T c2_y[8]);
...
static void c2_eml_error(SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *
  chartInstance, int32_T c2_varargin_2);
...
static void c2_d_emlrt_marshallIn
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance, const
   mxArray *c2_y, const char_T *c2_identifier, uint8_T c2_b_y[8]);
...
static uint8_T c2_f_emlrt_marshallIn
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance, const
   mxArray *c2_b_is_active_c2_QPSK_Transmit_v12c_optimizing_games, const char_T *
   c2_identifier);
static uint8_T c2_g_emlrt_marshallIn
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance, const
   mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static uint32_T c2__u32_minus__
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance,
   uint32_T c2_b, uint32_T c2_c);
static uint8_T c2__u8_u32_
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance,
   uint32_T c2_b);
static uint8_T c2__u8_d_(SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *
  chartInstance, real_T c2_b);
  ...
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_QPSK_Transmit_v12c_optimizing_games = 0U;
  ...
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal =
    chartInstance->c2_is_active_c2_QPSK_Transmit_v12c_optimizing_games;
   ...
   mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_QPSK_Transmit_v12c_optimizing_games =
    ...
    "is_active_c2_QPSK_Transmit_v12c_optimizing_games");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_QPSK_Transmit_v12c_optimizing_games(chartInstance);
  ...
  (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_sfEvent = CALL_EVENT;
  c2_chartstep_c2_QPSK_Transmit_v12c_optimizing_games(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance;
  chartInstance = (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c2_QPSK_Transmit_v12c_optimizing_games_get_eml_resolved_functions_info
  (void)
{
   ...
   c2_identifier)
{
  ...
  c2_y = c2_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_QPSK_Transmit_v12c_optimizing_games), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_QPSK_Transmit_v12c_optimizing_games);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_QPSK_Transmit_v12c_optimizing_games_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_QPSK_Transmit_v12c_optimizing_games_get_autoinheritance_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c2_QPSK_Transmit_v12c_optimizing_games(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c2_QPSK_Transmit_v12c_optimizing_games\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_QPSK_Transmit_v12c_optimizing_games_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_QPSK_Transmit_v12c_optimizing_games(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*) chartInstanceVar)
     ->S,0);
  initialize_params_c2_QPSK_Transmit_v12c_optimizing_games
    ((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*) chartInstanceVar);
  initialize_c2_QPSK_Transmit_v12c_optimizing_games
    ((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_QPSK_Transmit_v12c_optimizing_games(void
  *chartInstanceVar)
{
  enable_c2_QPSK_Transmit_v12c_optimizing_games
    ((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_QPSK_Transmit_v12c_optimizing_games(void
  *chartInstanceVar)
{
  disable_c2_QPSK_Transmit_v12c_optimizing_games
    ((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_QPSK_Transmit_v12c_optimizing_games(void
  *chartInstanceVar)
{
  sf_c2_QPSK_Transmit_v12c_optimizing_games
    ((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c2_QPSK_Transmit_v12c_optimizing_games(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_QPSK_Transmit_v12c_optimizing_games
    ((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c2_QPSK_Transmit_v12c_optimizing_games();/* state var info */
...
extern void sf_internal_set_sim_state_c2_QPSK_Transmit_v12c_optimizing_games
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c2_QPSK_Transmit_v12c_optimizing_games
    ((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c2_QPSK_Transmit_v12c_optimizing_games(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_QPSK_Transmit_v12c_optimizing_games(S);
}

static void sf_opaque_set_sim_state_c2_QPSK_Transmit_v12c_optimizing_games
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c2_QPSK_Transmit_v12c_optimizing_games(S, st);
}

static void sf_opaque_terminate_c2_QPSK_Transmit_v12c_optimizing_games(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_QPSK_Transmit_v12c_optimizing_games
      ((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc2_QPSK_Transmit_v12c_optimizing_games
    ((SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_QPSK_Transmit_v12c_optimizing_games
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_QPSK_Transmit_v12c_optimizing_games(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
...
static void mdlRTW_c2_QPSK_Transmit_v12c_optimizing_games(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_QPSK_Transmit_v12c_optimizing_games(SimStruct *S)
{
  SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *chartInstance;
  chartInstance = (SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct *)
    malloc(sizeof(SFc2_QPSK_Transmit_v12c_optimizing_gamesInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_QPSK_Transmit_v12c_optimizing_games;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_QPSK_Transmit_v12c_optimizing_games;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_QPSK_Transmit_v12c_optimizing_games;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_QPSK_Transmit_v12c_optimizing_games;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_QPSK_Transmit_v12c_optimizing_games;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_QPSK_Transmit_v12c_optimizing_games;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_QPSK_Transmit_v12c_optimizing_games;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_QPSK_Transmit_v12c_optimizing_games;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c2_QPSK_Transmit_v12c_optimizing_games;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_QPSK_Transmit_v12c_optimizing_games;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_QPSK_Transmit_v12c_optimizing_games;
...
void c2_QPSK_Transmit_v12c_optimizing_games_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_QPSK_Transmit_v12c_optimizing_games(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_QPSK_Transmit_v12c_optimizing_games(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_QPSK_Transmit_v12c_optimizing_games(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_QPSK_Transmit_v12c_optimizing_games_method_dispatcher.\n"
