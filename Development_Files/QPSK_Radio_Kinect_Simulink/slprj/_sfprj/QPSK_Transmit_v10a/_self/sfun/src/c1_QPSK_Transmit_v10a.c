...
#include "c1_QPSK_Transmit_v10a.h"
...
static void initialize_c1_QPSK_Transmit_v10a
  (SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance);
static void initialize_params_c1_QPSK_Transmit_v10a
  (SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance);
static void enable_c1_QPSK_Transmit_v10a(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance);
static void disable_c1_QPSK_Transmit_v10a(SFc1_QPSK_Transmit_v10aInstanceStruct *
  chartInstance);
static void c1_update_debugger_state_c1_QPSK_Transmit_v10a
  (SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_QPSK_Transmit_v10a
  (SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance);
static void set_sim_state_c1_QPSK_Transmit_v10a
  (SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_QPSK_Transmit_v10a(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance);
static void sf_c1_QPSK_Transmit_v10a(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance);
static void c1_chartstep_c1_QPSK_Transmit_v10a
  (SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance);
static void initSimStructsc1_QPSK_Transmit_v10a
  (SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance, const mxArray *c1_b_buf, const char_T *c1_identifier, cint8_T
  c1_y[17]);
static void c1_b_emlrt_marshallIn(SFc1_QPSK_Transmit_v10aInstanceStruct
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static cint16_T c1_c_emlrt_marshallIn(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_d_emlrt_marshallIn(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_g_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_e_emlrt_marshallIn(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[17]);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[61]);
static void c1_eml_fi_checkforconst(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance);
static cint32_T c1_mtimes(SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance,
  cint8_T c1_a0[17]);
static const mxArray *c1_h_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_f_emlrt_marshallIn(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_i_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static cint16_T c1_g_emlrt_marshallIn(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance, const mxArray *c1_d_out, const char_T *c1_identifier);
static cint16_T c1_h_emlrt_marshallIn(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_i_emlrt_marshallIn(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_QPSK_Transmit_v10a, const
  char_T *c1_identifier);
static uint8_T c1_j_emlrt_marshallIn(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_QPSK_Transmit_v10aInstanceStruct
  *chartInstance);
  ...
  (SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_QPSK_Transmit_v10a = 0U;
  ...
  (SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_QPSK_Transmit_v10a;
  ...
  (SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_d_out = c1_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c1_is_active_c1_QPSK_Transmit_v10a = c1_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_QPSK_Transmit_v10a");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_QPSK_Transmit_v10a(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_QPSK_Transmit_v10a(chartInstance);
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_b_y = NULL;
  SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance;
  chartInstance = (SFc1_QPSK_Transmit_v10aInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_QPSK_Transmit_v10a_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_QPSK_Transmit_v10a), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_QPSK_Transmit_v10a);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_QPSK_Transmit_v10a_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_QPSK_Transmit_v10a_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_QPSK_Transmit_v10a(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"d_out\",},{M[4],M[0],T\"buf\",S'l','i','p'{{M1x2[62 65],M[0],}}},{M[8],M[0],T\"is_active_c1_QPSK_Transmit_v10a\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_QPSK_Transmit_v10a_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance;
    chartInstance = (SFc1_QPSK_Transmit_v10aInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c1_QPSK_Transmit_v10a(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_QPSK_Transmit_v10aInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_QPSK_Transmit_v10a((SFc1_QPSK_Transmit_v10aInstanceStruct*)
    chartInstanceVar);
  initialize_c1_QPSK_Transmit_v10a((SFc1_QPSK_Transmit_v10aInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_QPSK_Transmit_v10a(void *chartInstanceVar)
{
  enable_c1_QPSK_Transmit_v10a((SFc1_QPSK_Transmit_v10aInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_QPSK_Transmit_v10a(void *chartInstanceVar)
{
  disable_c1_QPSK_Transmit_v10a((SFc1_QPSK_Transmit_v10aInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_QPSK_Transmit_v10a(void *chartInstanceVar)
{
  sf_c1_QPSK_Transmit_v10a((SFc1_QPSK_Transmit_v10aInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_QPSK_Transmit_v10a(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_QPSK_Transmit_v10a
    ((SFc1_QPSK_Transmit_v10aInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_QPSK_Transmit_v10a();/* state var info */
...
extern void sf_internal_set_sim_state_c1_QPSK_Transmit_v10a(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_QPSK_Transmit_v10a((SFc1_QPSK_Transmit_v10aInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_QPSK_Transmit_v10a(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_QPSK_Transmit_v10a(S);
}

static void sf_opaque_set_sim_state_c1_QPSK_Transmit_v10a(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_QPSK_Transmit_v10a(S, st);
}

static void sf_opaque_terminate_c1_QPSK_Transmit_v10a(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_QPSK_Transmit_v10aInstanceStruct*) chartInstanceVar)
      ->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_QPSK_Transmit_v10a((SFc1_QPSK_Transmit_v10aInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_QPSK_Transmit_v10a((SFc1_QPSK_Transmit_v10aInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_QPSK_Transmit_v10a(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_QPSK_Transmit_v10a
      ((SFc1_QPSK_Transmit_v10aInstanceStruct*)(((ChartInfoStruct *)
         ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_QPSK_Transmit_v10a(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c1_QPSK_Transmit_v10a(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_QPSK_Transmit_v10a(SimStruct *S)
{
  SFc1_QPSK_Transmit_v10aInstanceStruct *chartInstance;
  chartInstance = (SFc1_QPSK_Transmit_v10aInstanceStruct *)malloc(sizeof
    (SFc1_QPSK_Transmit_v10aInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_QPSK_Transmit_v10aInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_QPSK_Transmit_v10a;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_QPSK_Transmit_v10a;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_QPSK_Transmit_v10a;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_QPSK_Transmit_v10a;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_QPSK_Transmit_v10a;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_QPSK_Transmit_v10a;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_QPSK_Transmit_v10a;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_QPSK_Transmit_v10a;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_QPSK_Transmit_v10a;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_QPSK_Transmit_v10a;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_QPSK_Transmit_v10a;
...
void c1_QPSK_Transmit_v10a_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_QPSK_Transmit_v10a(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_QPSK_Transmit_v10a(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_QPSK_Transmit_v10a(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_QPSK_Transmit_v10a_method_dispatcher.\n"
