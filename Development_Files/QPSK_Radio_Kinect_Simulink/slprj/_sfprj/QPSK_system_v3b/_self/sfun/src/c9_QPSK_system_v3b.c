...
#include "QPSK_system_v3b_sfun.h"
#include "c9_QPSK_system_v3b.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "QPSK_system_v3b_sfun_debug_macros.h"
...
static void initialize_c9_QPSK_system_v3b(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance);
static void initialize_params_c9_QPSK_system_v3b
  (SFc9_QPSK_system_v3bInstanceStruct *chartInstance);
static void enable_c9_QPSK_system_v3b(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance);
static void disable_c9_QPSK_system_v3b(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance);
static void c9_update_debugger_state_c9_QPSK_system_v3b
  (SFc9_QPSK_system_v3bInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c9_QPSK_system_v3b
  (SFc9_QPSK_system_v3bInstanceStruct *chartInstance);
static void set_sim_state_c9_QPSK_system_v3b(SFc9_QPSK_system_v3bInstanceStruct *
  chartInstance, const mxArray *c9_st);
static void finalize_c9_QPSK_system_v3b(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance);
static void sf_c9_QPSK_system_v3b(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance);
static void initSimStructsc9_QPSK_system_v3b(SFc9_QPSK_system_v3bInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c9_machineNumber, uint32_T
  c9_chartNumber);
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData);
static cint16_T c9_emlrt_marshallIn(SFc9_QPSK_system_v3bInstanceStruct
...
static const mxArray *c9_c_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static real_T c9_b_emlrt_marshallIn(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
...
static const mxArray *c9_e_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static int32_T c9_c_emlrt_marshallIn(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static const mxArray *c9_f_sf_marshallOut(void *chartInstanceVoid, void
  *c9_inData);
static cint16_T c9_d_emlrt_marshallIn(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance, const mxArray *c9_d_out, const char_T *c9_identifier);
static cint16_T c9_e_emlrt_marshallIn(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void c9_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c9_mxArrayInData, const char_T *c9_varName, void *c9_outData);
static uint8_T c9_f_emlrt_marshallIn(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance, const mxArray *c9_b_is_active_c9_QPSK_system_v3b, const char_T
  *c9_identifier);
static uint8_T c9_g_emlrt_marshallIn(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance, const mxArray *c9_u, const emlrtMsgIdentifier *c9_parentId);
static void init_dsm_address_info(SFc9_QPSK_system_v3bInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c9_is_active_c9_QPSK_system_v3b = 0U;
  ...
  (SFc9_QPSK_system_v3bInstanceStruct *chartInstance)
{
  ...
  c9_hoistedGlobal = chartInstance->c9_is_active_c9_QPSK_system_v3b;
  ...
  chartInstance, const mxArray *c9_st)
{
  ...
  *c9_d_out = c9_d_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
    (c9_u, 0)), "d_out");
  chartInstance->c9_is_active_c9_QPSK_system_v3b = c9_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c9_u, 1)),
     "is_active_c9_QPSK_system_v3b");
  sf_mex_destroy(&c9_u);
  c9_update_debugger_state_c9_QPSK_system_v3b(chartInstance);
  ...
  *chartInstance)
{
  ...
  sf_debug_check_for_state_inconsistency(_QPSK_system_v3bMachineNumber_,
...
static const mxArray *c9_sf_marshallOut(void *chartInstanceVoid, void *c9_inData)
{
  ...
  const mxArray *c9_b_y = NULL;
  SFc9_QPSK_system_v3bInstanceStruct *chartInstance;
  chartInstance = (SFc9_QPSK_system_v3bInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c9_QPSK_system_v3b_get_eml_resolved_functions_info(void)
{
  ...
  *c9_identifier)
{
  ...
  c9_y = c9_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c9_b_is_active_c9_QPSK_system_v3b), &c9_thisId);
  sf_mex_destroy(&c9_b_is_active_c9_QPSK_system_v3b);
  return c9_y;
}
...
/* SFunction Glue Code */
void sf_c9_QPSK_system_v3b_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(381427611U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1659857163U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3471030790U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4079203274U);
}

mxArray *sf_c9_QPSK_system_v3b_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c9_QPSK_system_v3b(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"d_out\",},{M[8],M[0],T\"is_active_c9_QPSK_system_v3b\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c9_QPSK_system_v3b_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc9_QPSK_system_v3bInstanceStruct *chartInstance;
    chartInstance = (SFc9_QPSK_system_v3bInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_QPSK_system_v3bMachineNumber_,
           9,
           1,
           1,
           2,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_QPSK_system_v3bMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_QPSK_system_v3bMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_QPSK_system_v3bMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
        ...
        _SFD_SET_DATA_COMPILED_PROPS(1,SF_INT16,0,NULL,1,1,12,0,1,-11,1,
          (MexFcnForType)c9_f_sf_marshallOut,(MexInFcnForType)c9_d_sf_marshallIn);

        {
          creal_T *c9_d_in;
          cint16_T *c9_d_out;
          c9_d_out = (cint16_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c9_d_in = (creal_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c9_d_in);
          _SFD_SET_DATA_VALUE_PTR(1U, c9_d_out);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration(_QPSK_system_v3bMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}
...
{
  return "kbD7rJITjzigjy46nnhGMC";
}

static void sf_opaque_initialize_c9_QPSK_system_v3b(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc9_QPSK_system_v3bInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c9_QPSK_system_v3b((SFc9_QPSK_system_v3bInstanceStruct*)
    chartInstanceVar);
  initialize_c9_QPSK_system_v3b((SFc9_QPSK_system_v3bInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c9_QPSK_system_v3b(void *chartInstanceVar)
{
  enable_c9_QPSK_system_v3b((SFc9_QPSK_system_v3bInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c9_QPSK_system_v3b(void *chartInstanceVar)
{
  disable_c9_QPSK_system_v3b((SFc9_QPSK_system_v3bInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c9_QPSK_system_v3b(void *chartInstanceVar)
{
  sf_c9_QPSK_system_v3b((SFc9_QPSK_system_v3bInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c9_QPSK_system_v3b(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c9_QPSK_system_v3b
    ((SFc9_QPSK_system_v3bInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c9_QPSK_system_v3b();/* state var info */
...
extern void sf_internal_set_sim_state_c9_QPSK_system_v3b(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c9_QPSK_system_v3b((SFc9_QPSK_system_v3bInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c9_QPSK_system_v3b(SimStruct* S)
{
  return sf_internal_get_sim_state_c9_QPSK_system_v3b(S);
}

static void sf_opaque_set_sim_state_c9_QPSK_system_v3b(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c9_QPSK_system_v3b(S, st);
}

static void sf_opaque_terminate_c9_QPSK_system_v3b(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc9_QPSK_system_v3bInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c9_QPSK_system_v3b((SFc9_QPSK_system_v3bInstanceStruct*)
      chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_QPSK_system_v3b_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc9_QPSK_system_v3b((SFc9_QPSK_system_v3bInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c9_QPSK_system_v3b(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c9_QPSK_system_v3b(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_QPSK_system_v3b_optimization_info();
  ...
  ssSetChecksum0(S,(199537983U));
  ssSetChecksum1(S,(418503255U));
  ssSetChecksum2(S,(3436310415U));
  ssSetChecksum3(S,(2608615326U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c9_QPSK_system_v3b(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c9_QPSK_system_v3b(SimStruct *S)
{
  SFc9_QPSK_system_v3bInstanceStruct *chartInstance;
  chartInstance = (SFc9_QPSK_system_v3bInstanceStruct *)malloc(sizeof
    (SFc9_QPSK_system_v3bInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc9_QPSK_system_v3bInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c9_QPSK_system_v3b;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c9_QPSK_system_v3b;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c9_QPSK_system_v3b;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c9_QPSK_system_v3b;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c9_QPSK_system_v3b;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c9_QPSK_system_v3b;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c9_QPSK_system_v3b;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c9_QPSK_system_v3b;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c9_QPSK_system_v3b;
  chartInstance->chartInfo.mdlStart = mdlStart_c9_QPSK_system_v3b;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c9_QPSK_system_v3b;
...
void c9_QPSK_system_v3b_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c9_QPSK_system_v3b(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c9_QPSK_system_v3b(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c9_QPSK_system_v3b(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c9_QPSK_system_v3b_method_dispatcher.\n"
