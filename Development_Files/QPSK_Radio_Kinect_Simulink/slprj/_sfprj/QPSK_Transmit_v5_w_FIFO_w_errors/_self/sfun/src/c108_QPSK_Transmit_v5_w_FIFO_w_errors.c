...
#include "QPSK_Transmit_v5_w_FIFO_w_errors_sfun_debug_macros.h"
...
static void initialize_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance);
static void initialize_params_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance);
static void enable_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance);
static void disable_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance);
static void c108_update_debugger_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance);
static void set_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance, const
   mxArray *c108_st);
static void finalize_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance);
static void sf_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance);
static void c108_chartstep_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance);
static void initSimStructsc108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance);
...
static const mxArray *c108_sf_marshallOut(void *chartInstanceVoid, void
  *c108_inData);
static void c108_emlrt_marshallIn
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance, const
   mxArray *c108_u, const emlrtMsgIdentifier *c108_parentId, uint8_T c108_y[8]);
...
static const mxArray *c108_c_sf_marshallOut(void *chartInstanceVoid, void
  *c108_inData);
static real_T c108_b_emlrt_marshallIn
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance, const
...
static void c108_eml_error(SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct
  *chartInstance, int32_T c108_varargin_2);
static const mxArray *c108_d_sf_marshallOut(void *chartInstanceVoid, void
  *c108_inData);
static int32_T c108_c_emlrt_marshallIn
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance, const
   mxArray *c108_u, const emlrtMsgIdentifier *c108_parentId);
...
static const mxArray *c108_f_sf_marshallOut(void *chartInstanceVoid, void
  *c108_inData);
static void c108_d_emlrt_marshallIn
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance, const
   mxArray *c108_y, const char_T *c108_identifier, uint8_T c108_b_y[8]);
static void c108_e_emlrt_marshallIn
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance, const
   mxArray *c108_u, const emlrtMsgIdentifier *c108_parentId, uint8_T c108_y[8]);
...
static uint8_T c108_f_emlrt_marshallIn
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance, const
   mxArray *c108_b_is_active_c108_QPSK_Transmit_v5_w_FIFO_w_errors, const char_T
   *c108_identifier);
static uint8_T c108_g_emlrt_marshallIn
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance, const
   mxArray *c108_u, const emlrtMsgIdentifier *c108_parentId);
static uint32_T c108__u32_minus__
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance,
   uint32_T c108_b, uint32_T c108_c);
static uint8_T c108__u8_u32_
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance,
   uint32_T c108_b);
static uint8_T c108__u8_d_(SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct
  ...
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c108_is_active_c108_QPSK_Transmit_v5_w_FIFO_w_errors = 0U;
  ...
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance)
{
  ...
  c108_hoistedGlobal =
    chartInstance->c108_is_active_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
   ...
   mxArray *c108_st)
{
  ...
  chartInstance->c108_is_active_c108_QPSK_Transmit_v5_w_FIFO_w_errors =
    ...
    "is_active_c108_QPSK_Transmit_v5_w_FIFO_w_errors");
  sf_mex_destroy(&c108_u);
  c108_update_debugger_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors(chartInstance);
  ...
  (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance)
{
  ...
  chartInstance->c108_sfEvent = CALL_EVENT;
  c108_chartstep_c108_QPSK_Transmit_v5_w_FIFO_w_errors(chartInstance);
  sf_debug_check_for_state_inconsistency
    (_QPSK_Transmit_v5_w_FIFO_w_errorsMachineNumber_, chartInstance->chartNumber,
  ...
  *c108_inData)
{
  ...
  const mxArray *c108_b_y = NULL;
  SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance;
  chartInstance = (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *)
    chartInstanceVoid;
...
const mxArray
  *sf_c108_QPSK_Transmit_v5_w_FIFO_w_errors_get_eml_resolved_functions_info(void)
{
   ...
   *c108_identifier)
{
  ...
  c108_y = c108_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c108_b_is_active_c108_QPSK_Transmit_v5_w_FIFO_w_errors), &c108_thisId);
  sf_mex_destroy(&c108_b_is_active_c108_QPSK_Transmit_v5_w_FIFO_w_errors);
  return c108_y;
}
...
/* SFunction Glue Code */
void sf_c108_QPSK_Transmit_v5_w_FIFO_w_errors_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c108_QPSK_Transmit_v5_w_FIFO_w_errors_get_autoinheritance_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c108_QPSK_Transmit_v5_w_FIFO_w_errors(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c108_QPSK_Transmit_v5_w_FIFO_w_errors\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c108_QPSK_Transmit_v5_w_FIFO_w_errors_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_QPSK_Transmit_v5_w_FIFO_w_errorsMachineNumber_,
           108,
           1,
           1,
           2,
...
static void sf_opaque_initialize_c108_QPSK_Transmit_v5_w_FIFO_w_errors(void
  *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*) chartInstanceVar
     )->S,0);
  initialize_params_c108_QPSK_Transmit_v5_w_FIFO_w_errors
    ((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*) chartInstanceVar);
  initialize_c108_QPSK_Transmit_v5_w_FIFO_w_errors
    ((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c108_QPSK_Transmit_v5_w_FIFO_w_errors(void
  *chartInstanceVar)
{
  enable_c108_QPSK_Transmit_v5_w_FIFO_w_errors
    ((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c108_QPSK_Transmit_v5_w_FIFO_w_errors(void
  *chartInstanceVar)
{
  disable_c108_QPSK_Transmit_v5_w_FIFO_w_errors
    ((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c108_QPSK_Transmit_v5_w_FIFO_w_errors(void
  *chartInstanceVar)
{
  sf_c108_QPSK_Transmit_v5_w_FIFO_w_errors
    ((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*) chartInstanceVar);
}

extern const mxArray*
  sf_internal_get_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors
    ((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
  prhs[3] = (mxArray*)
    sf_get_sim_state_info_c108_QPSK_Transmit_v5_w_FIFO_w_errors();/* state var info */
...
extern void sf_internal_set_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SimStruct* S, const mxArray *st)
{
  ...
  set_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors
    ((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*)
...
static const mxArray*
  sf_opaque_get_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors(SimStruct* S)
{
  return sf_internal_get_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors(S);
}

static void sf_opaque_set_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors
  (SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors(S, st);
}

static void sf_opaque_terminate_c108_QPSK_Transmit_v5_w_FIFO_w_errors(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c108_QPSK_Transmit_v5_w_FIFO_w_errors
      ((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*) chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_QPSK_Transmit_v5_w_FIFO_w_errors_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc108_QPSK_Transmit_v5_w_FIFO_w_errors
    ((SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c108_QPSK_Transmit_v5_w_FIFO_w_errors(SimStruct
  *S)
{
  int i;
...
static void mdlSetWorkWidths_c108_QPSK_Transmit_v5_w_FIFO_w_errors(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_QPSK_Transmit_v5_w_FIFO_w_errors_optimization_info();
...
static void mdlRTW_c108_QPSK_Transmit_v5_w_FIFO_w_errors(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c108_QPSK_Transmit_v5_w_FIFO_w_errors(SimStruct *S)
{
  SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *chartInstance;
  chartInstance = (SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct *)
    malloc(sizeof(SFc108_QPSK_Transmit_v5_w_FIFO_w_errorsInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c108_QPSK_Transmit_v5_w_FIFO_w_errors;
...
void c108_QPSK_Transmit_v5_w_FIFO_w_errors_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c108_QPSK_Transmit_v5_w_FIFO_w_errors(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c108_QPSK_Transmit_v5_w_FIFO_w_errors(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c108_QPSK_Transmit_v5_w_FIFO_w_errors(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c108_QPSK_Transmit_v5_w_FIFO_w_errors_method_dispatcher.\n"
