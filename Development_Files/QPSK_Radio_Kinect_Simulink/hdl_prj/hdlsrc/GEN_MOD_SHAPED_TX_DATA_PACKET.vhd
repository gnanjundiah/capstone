...
-- Source Path: QPSK_system_v3g/TX_SYSTEM_TOP/TX_CORE_DELAYED_SUBSYSTEM/TX_CORE/GEN_MOD_SHAPED_TX_DATA_PACKET
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF GEN_MOD_SHAPED_TX_DATA_PACKET IS
  ...
  COMPONENT QPSK_SRRC
    PORT( clk                             :   IN    std_logic;
          ...
          reset                           :   IN    std_logic;
          QPSK_SRRC_in_re                 :   IN    std_logic_vector(7 DOWNTO 0);  -- int8
          QPSK_SRRC_in_im                 :   IN    std_logic_vector(7 DOWNTO 0);  -- int8
  ...
  SIGNAL GEN_MODULATED_TX_DATA_PACKET_EN_COUNTER_out1 : std_logic_vector(31 DOWNTO 0);  -- ufix32
  SIGNAL GEN_MODULATED_TX_DATA_PACKET_EN_COUNTER_out1_unsigned : unsigned(31 DOWNTO 0);  -- uint32
...
BEGIN
  u_GEN_MODULATED_TX_DATA_PACKET_EN_COUNTER : GEN_MODULATED_TX_DATA_PACKET_EN_COUNTER
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb_gated,
              GEN_MODULATED_TX_DATA_PACKET_RESET => INITIALIZE_TX_CORE,
              GEN_MODULATED_TX_DATA_PACKET_EN_COUNT => GEN_MODULATED_TX_DATA_PACKET_EN_COUNTER_out1  -- uint32
              );
  ...
  u_QPSK_SRRC : QPSK_SRRC
    PORT MAP( clk => clk,
              enb_gated => enb_gated,
              reset => reset,
              QPSK_SRRC_in_re => GEN_MODULATED_TX_DATA_PACKET_out1,  -- int8
              QPSK_SRRC_in_im => GEN_MODULATED_TX_DATA_PACKET_out2,  -- int8
              QPSK_SRRC_out_re => QPSK_SRRC_out1_re,  -- sfix12_En11
              QPSK_SRRC_out_im => QPSK_SRRC_out1_im  -- sfix12_En11
              );
  ...
  GEN_MODULATED_TX_DATA_PACKET_EN_COUNTER_out1_unsigned <= unsigned(GEN_MODULATED_TX_DATA_PACKET_EN_COUNTER_out1);

  
  Compare_To_Constant5_out1 <= '1' WHEN GEN_MODULATED_TX_DATA_PACKET_EN_COUNTER_out1_unsigned = 0 ELSE
      '0';
