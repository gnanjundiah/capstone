...
#include "c1_QPSK_Transmit_v5_w_FIFO.h"
...
static void initialize_c1_QPSK_Transmit_v5_w_FIFO
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance);
static void initialize_params_c1_QPSK_Transmit_v5_w_FIFO
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance);
static void enable_c1_QPSK_Transmit_v5_w_FIFO
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance);
static void disable_c1_QPSK_Transmit_v5_w_FIFO
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_QPSK_Transmit_v5_w_FIFO
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_QPSK_Transmit_v5_w_FIFO
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance);
static void set_sim_state_c1_QPSK_Transmit_v5_w_FIFO
   ...
   *c1_st);
static void finalize_c1_QPSK_Transmit_v5_w_FIFO
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance);
static void sf_c1_QPSK_Transmit_v5_w_FIFO
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance);
static void initSimStructsc1_QPSK_Transmit_v5_w_FIFO
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance);
...
static void c1_emlrt_marshallIn(SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct
  *chartInstance, const mxArray *c1_b_buf, const char_T *c1_identifier, creal_T
  c1_y[17]);
static void c1_b_emlrt_marshallIn(SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static creal_T c1_c_emlrt_marshallIn(SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *
  chartInstance, const mxArray *c1_d_out, const char_T *c1_identifier);
static creal_T c1_d_emlrt_marshallIn(SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *
  chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_e_emlrt_marshallIn(SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_g_emlrt_marshallIn(SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *
  chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_h_emlrt_marshallIn(SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *
  chartInstance, const mxArray *c1_b_is_active_c1_QPSK_Transmit_v5_w_FIFO, const
  char_T *c1_identifier);
static uint8_T c1_i_emlrt_marshallIn(SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *
  chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct
  *chartInstance);
  ...
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_QPSK_Transmit_v5_w_FIFO = 0U;
}
  ...
  (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_QPSK_Transmit_v5_w_FIFO;
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_QPSK_Transmit_v5_w_FIFO), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_QPSK_Transmit_v5_w_FIFO);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_QPSK_Transmit_v5_w_FIFO_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_QPSK_Transmit_v5_w_FIFO_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_QPSK_Transmit_v5_w_FIFO(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"d_out\",},{M[4],M[0],T\"buf\",S'l','i','p'{{M1x2[46 49],M[0],}}},{M[8],M[0],T\"is_active_c1_QPSK_Transmit_v5_w_FIFO\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_QPSK_Transmit_v5_w_FIFO_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c1_QPSK_Transmit_v5_w_FIFO(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_QPSK_Transmit_v5_w_FIFO
    ((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*) chartInstanceVar);
  initialize_c1_QPSK_Transmit_v5_w_FIFO
    ((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_QPSK_Transmit_v5_w_FIFO(void *chartInstanceVar)
{
  enable_c1_QPSK_Transmit_v5_w_FIFO((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_QPSK_Transmit_v5_w_FIFO(void *chartInstanceVar)
{
  disable_c1_QPSK_Transmit_v5_w_FIFO((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_QPSK_Transmit_v5_w_FIFO(void *chartInstanceVar)
{
  sf_c1_QPSK_Transmit_v5_w_FIFO((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_QPSK_Transmit_v5_w_FIFO
  (SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_QPSK_Transmit_v5_w_FIFO
    ((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_QPSK_Transmit_v5_w_FIFO();/* state var info */
...
extern void sf_internal_set_sim_state_c1_QPSK_Transmit_v5_w_FIFO(SimStruct* S,
  const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_QPSK_Transmit_v5_w_FIFO
    ((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*)chartInfo->chartInstance,
     mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_QPSK_Transmit_v5_w_FIFO
  (SimStruct* S)
{
  return sf_internal_get_sim_state_c1_QPSK_Transmit_v5_w_FIFO(S);
}

static void sf_opaque_set_sim_state_c1_QPSK_Transmit_v5_w_FIFO(SimStruct* S,
  const mxArray *st)
{
  sf_internal_set_sim_state_c1_QPSK_Transmit_v5_w_FIFO(S, st);
}

static void sf_opaque_terminate_c1_QPSK_Transmit_v5_w_FIFO(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_QPSK_Transmit_v5_w_FIFO
      ((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_QPSK_Transmit_v5_w_FIFO
    ((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_QPSK_Transmit_v5_w_FIFO(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_QPSK_Transmit_v5_w_FIFO
      ((SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct*)(((ChartInfoStruct *)
...
static void mdlRTW_c1_QPSK_Transmit_v5_w_FIFO(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_QPSK_Transmit_v5_w_FIFO(SimStruct *S)
{
  SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *chartInstance;
  chartInstance = (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct *)malloc(sizeof
    (SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_QPSK_Transmit_v5_w_FIFOInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_QPSK_Transmit_v5_w_FIFO;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_QPSK_Transmit_v5_w_FIFO;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_QPSK_Transmit_v5_w_FIFO;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_QPSK_Transmit_v5_w_FIFO;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_QPSK_Transmit_v5_w_FIFO;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_QPSK_Transmit_v5_w_FIFO;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_QPSK_Transmit_v5_w_FIFO;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_QPSK_Transmit_v5_w_FIFO;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_QPSK_Transmit_v5_w_FIFO;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_QPSK_Transmit_v5_w_FIFO;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_QPSK_Transmit_v5_w_FIFO;
...
void c1_QPSK_Transmit_v5_w_FIFO_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_QPSK_Transmit_v5_w_FIFO(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_QPSK_Transmit_v5_w_FIFO(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_QPSK_Transmit_v5_w_FIFO(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_QPSK_Transmit_v5_w_FIFO_method_dispatcher.\n"
