...
#include "QPSK_Transmit_v12_sfun.h"
#include "c3_QPSK_Transmit_v12.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "QPSK_Transmit_v12_sfun_debug_macros.h"
...
static void initialize_c3_QPSK_Transmit_v12(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance);
static void initialize_params_c3_QPSK_Transmit_v12
  (SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance);
static void enable_c3_QPSK_Transmit_v12(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance);
static void disable_c3_QPSK_Transmit_v12(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_QPSK_Transmit_v12
  (SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_QPSK_Transmit_v12
  (SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance);
static void set_sim_state_c3_QPSK_Transmit_v12
  (SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_QPSK_Transmit_v12(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance);
static void sf_c3_QPSK_Transmit_v12(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance);
static void c3_chartstep_c3_QPSK_Transmit_v12
  (SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance);
static void initSimStructsc3_QPSK_Transmit_v12
  (SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static void c3_emlrt_marshallIn(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance, const mxArray *c3_b_buf, const char_T *c3_identifier, cint8_T
  c3_y[17]);
static void c3_b_emlrt_marshallIn(SFc3_QPSK_Transmit_v12InstanceStruct
...
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static cint16_T c3_c_emlrt_marshallIn(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static real_T c3_d_emlrt_marshallIn(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_g_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_e_emlrt_marshallIn(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[17]);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[61]);
static void c3_eml_fi_checkforconst(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance);
static cint32_T c3_mtimes(SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance,
  cint8_T c3_a0[17]);
static const mxArray *c3_h_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_f_emlrt_marshallIn(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_i_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static cint16_T c3_g_emlrt_marshallIn(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance, const mxArray *c3_d_out, const char_T *c3_identifier);
static cint16_T c3_h_emlrt_marshallIn(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_f_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_i_emlrt_marshallIn(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_QPSK_Transmit_v12, const
  char_T *c3_identifier);
static uint8_T c3_j_emlrt_marshallIn(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_QPSK_Transmit_v12InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_QPSK_Transmit_v12 = 0U;
  ...
  (SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance)
{
  ...
  c3_hoistedGlobal = chartInstance->c3_is_active_c3_QPSK_Transmit_v12;
  ...
  (SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_d_out = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c3_is_active_c3_QPSK_Transmit_v12 = c3_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
     "is_active_c3_QPSK_Transmit_v12");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_QPSK_Transmit_v12(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_QPSK_Transmit_v12(chartInstance);
  sf_debug_check_for_state_inconsistency(_QPSK_Transmit_v12MachineNumber_,
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_b_y = NULL;
  SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance;
  chartInstance = (SFc3_QPSK_Transmit_v12InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_QPSK_Transmit_v12_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_QPSK_Transmit_v12), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_QPSK_Transmit_v12);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_QPSK_Transmit_v12_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_QPSK_Transmit_v12_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_QPSK_Transmit_v12(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"d_out\",},{M[4],M[0],T\"buf\",S'l','i','p'{{M1x2[62 65],M[0],}}},{M[8],M[0],T\"is_active_c3_QPSK_Transmit_v12\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_QPSK_Transmit_v12_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance;
    chartInstance = (SFc3_QPSK_Transmit_v12InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_QPSK_Transmit_v12MachineNumber_,
           3,
           1,
           1,
           2,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_QPSK_Transmit_v12MachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_QPSK_Transmit_v12MachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_QPSK_Transmit_v12MachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
      ...
      sf_debug_reset_current_state_configuration
        (_QPSK_Transmit_v12MachineNumber_,chartInstance->chartNumber,
         chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c3_QPSK_Transmit_v12(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_QPSK_Transmit_v12InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_QPSK_Transmit_v12((SFc3_QPSK_Transmit_v12InstanceStruct*)
    chartInstanceVar);
  initialize_c3_QPSK_Transmit_v12((SFc3_QPSK_Transmit_v12InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_QPSK_Transmit_v12(void *chartInstanceVar)
{
  enable_c3_QPSK_Transmit_v12((SFc3_QPSK_Transmit_v12InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_QPSK_Transmit_v12(void *chartInstanceVar)
{
  disable_c3_QPSK_Transmit_v12((SFc3_QPSK_Transmit_v12InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_QPSK_Transmit_v12(void *chartInstanceVar)
{
  sf_c3_QPSK_Transmit_v12((SFc3_QPSK_Transmit_v12InstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_QPSK_Transmit_v12(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_QPSK_Transmit_v12
    ((SFc3_QPSK_Transmit_v12InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_QPSK_Transmit_v12();/* state var info */
...
extern void sf_internal_set_sim_state_c3_QPSK_Transmit_v12(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_QPSK_Transmit_v12((SFc3_QPSK_Transmit_v12InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_QPSK_Transmit_v12(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_QPSK_Transmit_v12(S);
}

static void sf_opaque_set_sim_state_c3_QPSK_Transmit_v12(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_QPSK_Transmit_v12(S, st);
}

static void sf_opaque_terminate_c3_QPSK_Transmit_v12(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_QPSK_Transmit_v12InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_QPSK_Transmit_v12((SFc3_QPSK_Transmit_v12InstanceStruct*)
      chartInstanceVar);
    free((void *)chartInstanceVar);
    ssSetUserData(S,NULL);
  }

  unload_QPSK_Transmit_v12_optimization_info();
}

static void sf_opaque_init_subchart_simstructs(void *chartInstanceVar)
{
  initSimStructsc3_QPSK_Transmit_v12((SFc3_QPSK_Transmit_v12InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_QPSK_Transmit_v12(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_QPSK_Transmit_v12(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_QPSK_Transmit_v12_optimization_info();
...
static void mdlRTW_c3_QPSK_Transmit_v12(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_QPSK_Transmit_v12(SimStruct *S)
{
  SFc3_QPSK_Transmit_v12InstanceStruct *chartInstance;
  chartInstance = (SFc3_QPSK_Transmit_v12InstanceStruct *)malloc(sizeof
    (SFc3_QPSK_Transmit_v12InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_QPSK_Transmit_v12InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_QPSK_Transmit_v12;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_QPSK_Transmit_v12;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_QPSK_Transmit_v12;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_QPSK_Transmit_v12;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_QPSK_Transmit_v12;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_QPSK_Transmit_v12;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_QPSK_Transmit_v12;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_QPSK_Transmit_v12;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_QPSK_Transmit_v12;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_QPSK_Transmit_v12;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_QPSK_Transmit_v12;
...
void c3_QPSK_Transmit_v12_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_QPSK_Transmit_v12(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_QPSK_Transmit_v12(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_QPSK_Transmit_v12(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_QPSK_Transmit_v12_method_dispatcher.\n"
