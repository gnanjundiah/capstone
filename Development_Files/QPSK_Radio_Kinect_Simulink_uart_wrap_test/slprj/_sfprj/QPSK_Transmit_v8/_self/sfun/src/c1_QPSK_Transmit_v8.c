...
static void initialize_c1_QPSK_Transmit_v8(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance);
static void initialize_params_c1_QPSK_Transmit_v8
  (SFc1_QPSK_Transmit_v8InstanceStruct *chartInstance);
static void enable_c1_QPSK_Transmit_v8(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance);
static void disable_c1_QPSK_Transmit_v8(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance);
static void c1_update_debugger_state_c1_QPSK_Transmit_v8
  (SFc1_QPSK_Transmit_v8InstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_QPSK_Transmit_v8
  (SFc1_QPSK_Transmit_v8InstanceStruct *chartInstance);
static void set_sim_state_c1_QPSK_Transmit_v8
  (SFc1_QPSK_Transmit_v8InstanceStruct *chartInstance, const mxArray *c1_st);
static void finalize_c1_QPSK_Transmit_v8(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance);
static void sf_c1_QPSK_Transmit_v8(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance);
static void initSimStructsc1_QPSK_Transmit_v8
  (SFc1_QPSK_Transmit_v8InstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance, const mxArray *c1_b_buf, const char_T *c1_identifier, creal_T
  c1_y[17]);
static void c1_b_emlrt_marshallIn(SFc1_QPSK_Transmit_v8InstanceStruct
...
static const mxArray *c1_b_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static creal_T c1_c_emlrt_marshallIn(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance, const mxArray *c1_d_out, const char_T *c1_identifier);
static creal_T c1_d_emlrt_marshallIn(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_e_emlrt_marshallIn(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_f_emlrt_marshallIn(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId,
  real_T c1_y[17]);
...
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_g_emlrt_marshallIn(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_h_emlrt_marshallIn(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_QPSK_Transmit_v8, const
  char_T *c1_identifier);
static uint8_T c1_i_emlrt_marshallIn(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_QPSK_Transmit_v8InstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_QPSK_Transmit_v8 = 0U;
}
  ...
  (SFc1_QPSK_Transmit_v8InstanceStruct *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_QPSK_Transmit_v8;
  ...
  (SFc1_QPSK_Transmit_v8InstanceStruct *chartInstance, const mxArray *c1_st)
{
  ...
  *c1_d_out = c1_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell
  ...
  chartInstance->c1_is_active_c1_QPSK_Transmit_v8 = c1_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 2)),
     "is_active_c1_QPSK_Transmit_v8");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_QPSK_Transmit_v8(chartInstance);
  ...
  *chartInstance)
{
  ...
  int32_T c1_i6;
  int32_T c1_i7;
  creal_T c1_hoistedGlobal[17];
  creal_T c1_dc0;
  int32_T c1_i8;
  creal_T c1_b_b;
  creal_T c1_b_hoistedGlobal;
  creal_T *c1_b_d_out;
  creal_T *c1_b_d_in;
  c1_b_d_out = (creal_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_d_in = (creal_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  chartInstance->c1_sfEvent = CALL_EVENT;
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  c1_d_in.re = c1_b_d_in->re;
  c1_d_in.im = c1_b_d_in->im;
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_nargout, 3U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_d_in, 4U, c1_b_sf_marshallOut);
  ...
  for (c1_i7 = 0; c1_i7 < 17; c1_i7++) {
    c1_hoistedGlobal[c1_i7] = chartInstance->c1_buf[c1_i7];
  }
  ...
  for (c1_i8 = 0; c1_i8 < 17; c1_i8++) {
    ...
    c1_b_b.im = 0.0;
    c1_b_hoistedGlobal.re = c1_hoistedGlobal[c1_i8].re * c1_b_b.re -
      c1_hoistedGlobal[c1_i8].im * c1_b_b.im;
    c1_b_hoistedGlobal.im = c1_hoistedGlobal[c1_i8].re * c1_b_b.im +
      c1_hoistedGlobal[c1_i8].im * c1_b_b.re;
    c1_dc0.re += c1_b_hoistedGlobal.re;
    c1_dc0.im += c1_b_hoistedGlobal.im;
  }
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_QPSK_Transmit_v8InstanceStruct *chartInstance;
  chartInstance = (SFc1_QPSK_Transmit_v8InstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_QPSK_Transmit_v8_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_QPSK_Transmit_v8), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_QPSK_Transmit_v8);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_QPSK_Transmit_v8_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1053397349U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1699157362U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3257605939U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(631155710U);
}

mxArray *sf_c1_QPSK_Transmit_v8_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("hxqWa7Wvk02U1lVFfM21xF");
...
static const mxArray *sf_get_sim_state_info_c1_QPSK_Transmit_v8(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"d_out\",},{M[4],M[0],T\"buf\",S'l','i','p'{{M1x2[46 49],M[0],}}},{M[8],M[0],T\"is_active_c1_QPSK_Transmit_v8\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_QPSK_Transmit_v8_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_QPSK_Transmit_v8InstanceStruct *chartInstance;
    chartInstance = (SFc1_QPSK_Transmit_v8InstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
...

        {
          ...
          creal_T *c1_d_out;
          c1_d_out = (creal_T *)ssGetOutputPortSignal(chartInstance->S, 1);
          c1_d_in = (creal_T *)ssGetInputPortSignal(chartInstance->S, 0);
...
{
  return "YXyRzpQoCiqbUkk5qgAJbF";
}

static void sf_opaque_initialize_c1_QPSK_Transmit_v8(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_QPSK_Transmit_v8InstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_QPSK_Transmit_v8((SFc1_QPSK_Transmit_v8InstanceStruct*)
    chartInstanceVar);
  initialize_c1_QPSK_Transmit_v8((SFc1_QPSK_Transmit_v8InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c1_QPSK_Transmit_v8(void *chartInstanceVar)
{
  enable_c1_QPSK_Transmit_v8((SFc1_QPSK_Transmit_v8InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_QPSK_Transmit_v8(void *chartInstanceVar)
{
  disable_c1_QPSK_Transmit_v8((SFc1_QPSK_Transmit_v8InstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_QPSK_Transmit_v8(void *chartInstanceVar)
{
  sf_c1_QPSK_Transmit_v8((SFc1_QPSK_Transmit_v8InstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_QPSK_Transmit_v8(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_QPSK_Transmit_v8
    ((SFc1_QPSK_Transmit_v8InstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_QPSK_Transmit_v8();/* state var info */
...
extern void sf_internal_set_sim_state_c1_QPSK_Transmit_v8(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_QPSK_Transmit_v8((SFc1_QPSK_Transmit_v8InstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_QPSK_Transmit_v8(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_QPSK_Transmit_v8(S);
}

static void sf_opaque_set_sim_state_c1_QPSK_Transmit_v8(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c1_QPSK_Transmit_v8(S, st);
}

static void sf_opaque_terminate_c1_QPSK_Transmit_v8(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_QPSK_Transmit_v8InstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_QPSK_Transmit_v8((SFc1_QPSK_Transmit_v8InstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc1_QPSK_Transmit_v8((SFc1_QPSK_Transmit_v8InstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_QPSK_Transmit_v8(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_QPSK_Transmit_v8(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(41359943U));
  ssSetChecksum1(S,(3824676635U));
  ssSetChecksum2(S,(2367014314U));
  ssSetChecksum3(S,(1019406618U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c1_QPSK_Transmit_v8(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_QPSK_Transmit_v8(SimStruct *S)
{
  SFc1_QPSK_Transmit_v8InstanceStruct *chartInstance;
  chartInstance = (SFc1_QPSK_Transmit_v8InstanceStruct *)malloc(sizeof
    (SFc1_QPSK_Transmit_v8InstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_QPSK_Transmit_v8InstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_QPSK_Transmit_v8;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_QPSK_Transmit_v8;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_QPSK_Transmit_v8;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_QPSK_Transmit_v8;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_QPSK_Transmit_v8;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_QPSK_Transmit_v8;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_QPSK_Transmit_v8;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_QPSK_Transmit_v8;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_QPSK_Transmit_v8;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_QPSK_Transmit_v8;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_QPSK_Transmit_v8;
...
void c1_QPSK_Transmit_v8_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_QPSK_Transmit_v8(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_QPSK_Transmit_v8(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_QPSK_Transmit_v8(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_QPSK_Transmit_v8_method_dispatcher.\n"
